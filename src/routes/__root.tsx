...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "منصة متكاملة لتسيير المطاعم الجزائرية — إدارة الطلبات، الكاشير، المطبخ، المخزون، الموارد البشرية والمنيو الإلكتروني في منصة واحدة." },
      { property: "og:title", content: "ساهل DZ — تسيير المطاعم بطريقة سهلة" },
      { property: "og:description", content: "منصة متكاملة لتسيير المطاعم الجزائرية — إدارة الطلبات، الكاشير، المطبخ، المخزون، الموارد البشرية والمنيو الإلكتروني في منصة واحدة." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@SahelDZ" },
      { name: "twitter:title", content: "ساهل DZ — تسيير المطاعم بطريقة سهلة" },
      { name: "twitter:description", content: "منصة متكاملة لتسيير المطاعم الجزائرية — إدارة الطلبات، الكاشير، المطبخ، المخزون، الموارد البشرية والمنيو الإلكتروني في منصة واحدة." },
