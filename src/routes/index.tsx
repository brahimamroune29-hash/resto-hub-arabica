    ...
    <div dir="rtl" style={{ minHeight: "100vh", background: "#0d0d0d", fontFamily: FONT, color: "#fff" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <Link to="/login" style={{ fontSize: 13, fontWeight: 600, color: "#9ca3af", textDecoration: "none", padding: "8px 14px" }}>
            دخول الموظفين
          </Link>
          <a
          ...
          <div className="arb-hero-flex" style={{ display: "flex", alignItems: "center", gap: 60 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontSize: 16, color: "#9ca3af", marginBottom: 36, lineHeight: 1.8 }}>
                مطعم أربيكا — تجربة طعام جزائرية أصيلة<br />
                بنكهات تراثية وأجواء دافئة في كل زيارة
              </p>
